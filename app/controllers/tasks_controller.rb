class TasksController < ApplicationController
  ...
  private
    ...
    def task_params
      task_params = params.require(:task).permit(:name, :job_type, :status, :options, :every, :at)
      options = JSON.parse(task_params[:options])
      task_params[:options] = options.keys.inject({}) do |result, key|
