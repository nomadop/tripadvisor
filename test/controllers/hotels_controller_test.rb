...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { location: @hotel.location, name: @hotel.name, rating: @hotel.rating, review_count: @hotel.review_count }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { location: @hotel.location, name: @hotel.name, rating: @hotel.rating, review_count: @hotel.review_count }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
